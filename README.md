...
- [ ] Get rid of Op::Else and OpEndIf. Have Op::If just to else clause and at the end of if clause do an Op::Jump past else clause
...
- [ ] Make Op::LAnd and Op::LOr skip the right expression when the left expression is false (Op::LAnd) or true (Op::LOr)
